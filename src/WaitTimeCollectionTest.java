...
public class WaitTimeCollectionTest {
	...
	@Test
	public void testWaitTimes() throws JSONException {
		WaitTimeCollection col = new WaitTimeCollection(parser);
		assertNotNull("Wait times should not be null", col.getWaitTimes());
	}
