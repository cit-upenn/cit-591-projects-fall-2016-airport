...
public class WaitTimeParserTest {
	...
	private final static String wait = "{\"CheckpointIndex\" : \"5\",\"WaitTime\" : \"3\",\"Created_Datetime\" : \"12/18/2016 9:12:49 AM\"}";
	...
	public void testGarageParser() throws JSONException {
		JSONObject j = new JSONObject(wait);
		WaitTime wait2 = parser.waitParser(j);
